      ...
      <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br />
                        <br />
                        <form method="POST" action="{{ url('/admin/assignment') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('admin.assignments.form', ['formMode' => 'create'])
